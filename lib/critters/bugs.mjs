...
import { drawCritter, TAU, withAlpha, mixHex } from './core.mjs';
...
export const bee = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  ...
  return { x: s * 0.13, y: s * 0.04, size: s * 0.7, eyeScale: 1.1, brows: false, hat: [s * 0.12, s * -0.38, s * 0.56] };
});

export const butterfly = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  const { ctx, o, s, sh, fillStroke, light, dark } = k;
  const col = o.color || '#ff7eb6', acc = o.color2 || mixHex(col, '#ffd166', 0.65);
  const op = wingOpen(o);
  for (const sx of [-1, 1]) {
    ctx.save(); ctx.scale(sx * (0.4 + 0.8 * op), 1.08);
  ...
  return { y: -s * 0.15, size: s * 0.62, eyeScale: 1.05, brows: false, hat: [s * 0, s * -0.44, s * 0.5] };
});

export const ladybug = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  ...
  return { x: s * 0.17, y: s * 0.1, size: s * 0.66, eyeScale: 1.05, brows: false, hat: [s * 0.16, s * -0.23, s * 0.54] };
});

export const snail = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  ...
  return { x: s * 0.25, y: -s * 0.05, size: s * 0.6, eyeScale: 1.05, brows: false, hat: [s * 0.24, s * -0.33, s * 0.52] };
});

export const caterpillar = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  ...
  return { x: s * 0.17, y: s * 0.0, size: s * 0.72, eyeScale: 1.05, brows: false, hat: [s * 0.16, s * -0.36, s * 0.6] };
});

export const dragonfly = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  ...
  return { x: s * 0.21, y: 0, size: s * 0.62, eyeScale: 1.15, brows: false, hat: [s * 0.2, s * -0.3, s * 0.52] };
});
