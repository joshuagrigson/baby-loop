...
export const hedgehog = withHat(0.14, -0.24, 0.56, (k) => {
  ...
  return { x: s * 0.13, y: s * 0.05, size: s * 0.6, brows: false, mouthY: 0.28, eyeScale: 1.05 };
});

export const firefly = withHat(0.14, -0.33, 0.54, (k) => {
  ...
  return { x: s * 0.15, y: -s * 0.02, size: s * 0.64, eyeScale: 1.05, brows: false };
});

export const mouse = withHat(0, -0.4, 0.58, (k) => {
  ...
  return { y: -s * 0.1, size: s * 0.66, mouthY: 0.24, eyeScale: 1.05 };
});

export const raccoon = withHat(0, -0.42, 0.6, (k) => {
  const { ctx, o, s, blob, sh, fillStroke, light } = k;
  ...
  return { y: -s * 0.1, size: s * 0.66, mouthY: 0.25, brows: false, eyeScale: 1.05 };
});
