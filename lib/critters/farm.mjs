...
const FACE = (s, extra = {}) => { const f = FACE0(s, extra); return { ...f, y: s * HC + (f.y - s * HEAD_Y) * G, size: f.size * G, hatSize: s * 1.02 }; };
...
export const sheep = (ctx, x, y, size, o = {}) => drawCritter(ctx, x, y, size, o, (k) => {
  ...
  return { x: s * 0.18, y: -s * 0.14, size: s * 0.64, ink: '#1b1b1b', brows: false, eyeScale: 1.1, cheeks: true, hatSize: s * 0.78 };
});
