...
// "If You're Happy and You Know It" (murky). "Happy Birthday to You" IS
// included: the 2015–16 Warner/Chappell ruling and settlement put it in the
// public domain (Marya v. Warner/Chappell, C.D. Cal.). Content ID may still flag PD melodies via someone's recording
...
Object.assign(MELODIES, {
  ...
  birthday: {
    name: 'Happy Birthday to You', source: 'Hill sisters, "Good Morning to All" (1893); PD per Marya v. Warner/Chappell (2015–16). Music-box arrangement.',
    meter: 3, holiday: 'birthday',
    // 8 bars of 3/4 with the two-eighth pickup folded into the final bar so the loop closes
    notes: 'G4:1/2 G4:1/2 A4:1 G4:1 C5:1 B4:2 G4:1/2 G4:1/2 A4:1 G4:1 D5:1 C5:2 ' +
           'G4:1/2 G4:1/2 G5:1 E5:1 C5:1 B4:1 A4:1 F5:1/2 F5:1/2 E5:1 C5:1 D5:1 C5:2',
    chords: 'C:1 C:3 G:3 G:3 C:3 C:3 F:3 F:1 G:2 C:2',
  },
  jingle: {
