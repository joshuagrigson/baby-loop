// Procedural nursery music. Pure JS DSP, no dependencies, renders a seamless
...
export function writeMusicWav(outPath, opts) {
  const m = renderMusic(opts);
  fs.writeFileSync(outPath, encodeWav(m.L, m.R));
  return m;
}
