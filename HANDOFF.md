...
8. **Calm positioning.** No cut faster than the loop change, slow drifts, moderate loudness (≈ −18 dBFS RMS). This is deliberate: the overstimulation critique of the genre is real (PLAYBOOK §2) and YouTube's July-2025 "inauthentic content" policy targets mass-produced templated uploads (PLAYBOOK §3). Two distinct long-form uploads a week, not a firehose.
